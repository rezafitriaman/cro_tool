...
function data() {
    var envi = {
        develop: false,
        testId: 'T422_outlet',
        urlOrigin: 'https://outlet.g-star.com/nl_nl/_ui/g-star/js/app/base.5c20bbf768dcbb1ef24454d50b8dba7e.js'
    };
    return envi;
}
exports.data = data;
function customCodeInit(developEnvi) {
    ...
    */
    ...
    var PaymentIcon = /** @class */ (function () {
        ...
        PaymentIcon.prototype.append = function (targetContainer, customClass) {
            ...
            if (targetContainer.length > 0) {
                ...
                else if (customClass == "custom-gray") {
                    targetContainer[0].classList.add(customClass);
                }
    ...
    mobileAllPage.append(mobileTargetContainerPersonalInfoAndAbove, 'custom-gray');
